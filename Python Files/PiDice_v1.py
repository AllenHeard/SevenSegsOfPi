...
delay = 0.5 # Define Constant for Counter delay

SevenSeg(0) # Blanks the display when the program is initially run
...
while True: # while True: means run this loop forever
    ...
    if PushButton == False: # if PushButton has not been pressed
        ...
        SevenSeg(0)
        time.sleep(delay)
        SevenSeg(6) # Call function 'SevenSeg' with a value of x=6
        time.sleep(delay) # wait a second
        SevenSeg(5) # Call function 'SevenSeg' with a value of x=5
        time.sleep(delay) # wait a second
        SevenSeg(4) # Call function 'SevenSeg' with a value of x=4
        time.sleep(delay) # wait a second
        SevenSeg(3) # Call function 'SevenSeg' with a value of x=3
        time.sleep(delay) # wait a second
        SevenSeg(2) # etc
        time.sleep(delay)
        SevenSeg(1)
